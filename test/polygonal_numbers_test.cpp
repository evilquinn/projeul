...
{
    std::set<size_t> known_polygonals = { 1, 4, 9, 16, 25, 36,
                                          49, 64, 81, 100 };
    polygonal_numbers polygonals(known_polygonals.size(),
...
{
    std::set<size_t> known_polygonals = { 1, 5, 12, 22, 35, 51,
                                          70, 92, 117, 145 };
    polygonal_numbers polygonals(known_polygonals.size(),
...
{
    std::set<size_t> known_polygonals = { 1, 6, 15, 28, 45, 66,
                                          91, 120, 153, 190 };
    polygonal_numbers polygonals(known_polygonals.size(),
...
{
    std::set<size_t> known_polygonals = { 1, 7, 18, 34, 55, 81,
                                          112, 148, 189, 235 };
    polygonal_numbers polygonals(known_polygonals.size(),
...
{
    std::set<size_t> known_polygonals = { 1, 8, 21, 40, 65, 96,
                                          133, 176, 225, 280 };
    polygonal_numbers polygonals(known_polygonals.size(),
